    ...
    return(
        <div>
            ...
            <main className="w-full py-8">
                <Card className="overflow-hidden w-full h-auto"
                    style={{
                    ...
                    <CardHeader className=" bottom-0 flex flex-row items-center space-x-4 pt-20 px-10">
                        ...
                        <div>
                            ...
                            <p className="text-white text-muted-foreground flex items-center gap-2">
                                By Creator
                                <CheckCircle2 className="h-4 w-4 text-blue-500" />
                            </p>
                            <p className="text-white text-muted-foreground">Open edition {1 / 1000} ETH</p>
                        </div>
                    </CardHeader>
                    <CardContent className="flex justify-between items-center p-4 p">
                        <div className="flex space-x-2">
                            <Button className="bg-white text-black rounded-lg px-4 py-2 font-bold text-xl">View drop</Button>
                        </div>
                    </CardContent>
                </Card>
            ...
            <div className="w-full flex gap-4 overflow-x-auto ">
                <Link href="/collections/froggy-friends">
                    <div className="min-w-[230px] max-w-full bg-white shadow rounded-lg p-4">
                ...
                <div className="min-w-[230px] bg-white shadow rounded-lg p-4">
